...
import com.example.recycleradapter.adapter.callback.NotifyCallback;
...
public abstract class ItemViewHolder<D> extends RecyclerView.ViewHolder implements NotifyCallback<D> {
     ...
     * <p>但是该方法也不是必然就会被执行的，而是在 {@link com.example.recycleradapter.adapter.callback.NotifyCallback#getChangePayload(Object, Object, Bundle)} 方法中获得了不同之处后才会被执行。
