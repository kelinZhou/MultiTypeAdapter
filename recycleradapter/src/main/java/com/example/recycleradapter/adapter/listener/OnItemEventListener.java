package com.example.recycleradapter.adapter.listener;
...
public abstract class OnItemEventListener<D> {
     ...
     *                        一般情况下该参数的值会和 position 参数的值一致。只有当使用 {@link com.example.recycleradapter.adapter.ItemAdapter}
     *                        作为 {@link com.example.recycleradapter.adapter.MultiTypeAdapter} 的子条目并使用该监听时这个值才有意义，
     ...
     * <P>如果当前Item事件监听是设置给 {@link com.example.recycleradapter.adapter.SingleTypeAdapter} 的，
